module Veg
        ...
        private
        def Veg::buy_products 
    
         @@categories=[]
         @@categories=["Italian","Maxican","Chinese","South Indian","North Indian","Continental"]
...
module Non_veg
    def Non_veg::set_details
        buy_products()
    end
    
    private
    def Non_veg::buy_products 
